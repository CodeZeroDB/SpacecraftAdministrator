...
public class NaveNoTripuladaE implements Serializable {
	/**
	 *
	 */
	...
	//Atributos
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqNoTri")
	@SequenceGenerator(name="seqNoTri", sequenceName = "SEQ_ID_NAVE_NO_TRIPULADA")
